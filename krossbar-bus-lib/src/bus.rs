...
use anyhow::Result;
use bson::Bson;
use krossbar_common_connection::{connection::Connection, one_time_connector::OneTimeConnector};
use log::*;
use tokio::{
    net::UnixStream,
    sync::{
...
impl Bus {
    ...
    /// Register incoming Krossbar monitor connections
    async fn register_monitor(&mut self, stream: UnixStream, hub_connection: &mut RpcConnection) {
        ...
        hub_connection.set_monitor(Box::new(self.monitor.clone_for_service("krossbar.bus")));
